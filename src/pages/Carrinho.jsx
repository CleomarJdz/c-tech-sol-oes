                ...
                {!pixConfirmed ? (
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                      <img src={qrForPayload(generatePixPayload(totalPix, pixName, pixCpf))} alt="QR PIX" style={{ width: 220, height: 220, background: '#fff', padding: 8, borderRadius: 6 }} />
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ marginTop: 12, display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                          ...
                          }} style={{ background: 'var(--ctech-blue-700)', color: '#fff', padding: '8px 12px', borderRadius: 6 }}>Concluir</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 12 }}>
                      ...
                      <button onClick={() => {
                        ...
                        }} style={{ background: 'var(--ctech-blue)', color: '#fff', padding: '8px 12px', borderRadius: 6 }}>Confirmar Pagamento</button>
                    </div>
                  </div>
                ) : (
                  <div>
